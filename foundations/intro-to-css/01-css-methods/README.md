...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? {1}
- Did you properly link the external CSS file in the HTML file? {1}
- Does the `div` element have CSS added via the external method? {1}
- Does the `p` element have CSS added via the internal method? {1}
- Does the `button` element have CSS added via the inline method? {1}
