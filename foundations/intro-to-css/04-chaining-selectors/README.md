...
### Self Check
- Did you properly chain class selectors for each rule? {1}
- Does the `proportioned` image retain its original square proportions? {1}
- Does the `distorted` image end up looking squished and, well, distorted? {1}
