...
- Does each element have a unique class name? {1}
- Did you use the grouping selector for styles that both elements share? {1}
- Did you make separate rules for the styles unique to each element? {1}
